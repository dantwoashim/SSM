...
export const jobRuns = pgTable("job_runs", {
  ...
  idempotencyIdx: index("job_runs_idempotency_key_idx").on(table.idempotencyKey),
}));
...
export const reports = pgTable("reports", {
  ...
  basisStateHash: text("basis_state_hash"),
  ...
  publishedArtifactStorageKey: text("published_artifact_storage_key"),
  publishedArtifactFileName: text("published_artifact_file_name"),
  publishedArtifactContentType: text("published_artifact_content_type"),
  publishedArtifactChecksumSha256: text("published_artifact_checksum_sha256"),
...
export const messages = pgTable("messages", {
  ...
  visibility: text("visibility").$type<MessageVisibility>().notNull(),
...
export const workerHeartbeats = pgTable("worker_heartbeats", {
  ...
  status: text("status").$type<WorkerHeartbeatStatus>().notNull(),
