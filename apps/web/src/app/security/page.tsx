...
const controls = [
  ...
  "Documented local backup steps for founder-operated deployments, with storage readiness checks in the app.",
  ...
  return (
    <>
      <PageHeader
        ...
        description="The launch baseline emphasizes least privilege, transparent deployment tradeoffs, and customer-safe handling of evidence artifacts."
      />
        ...
        <div className="layout-two">
          ...
          <div>
            ...
            <p className="mt-md">
              ...
              operating controls while formal compliance packaging is deferred
              until initial revenue.
            </p>
            <p className="mt-md">
